...
public class GoblinShaman : MonoBehaviour, IObject, ICombatable, IAnimEventReceiver
{
    [Header("Ability")]
    ...
    {
        Vector2 summonPosition = new Vector2(Random.Range(-3.5f, 3.5f), 0f);

        _AttackModule.SummonTargetedObject(summonPosition);
    }
